	...
	<div class="limiter">
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<img src="img/pappagallo1.png">
				<form class="login100-form validate-form">

					<span class="login100-form-title p-b-49 Text-red"> Hai già
						rilasciato un feedback. </span>
					<p class="txt1 text-center p-t-54 p-b-20">
						<a href="i-miei-ordini.jsp" class="txt2"> Clicca qui per
							tornare indietro </a>
					</p>
				</form>
			</div>
